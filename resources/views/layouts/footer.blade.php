...
<div class="footer">
    <div class="mdc-layout-grid">
        <div class="mdc-layout-grid__inner">
            <div class="mdc-layout-grid__cell--span-6-desktop mdc-layout-grid__cell--span-12-tablet mdc-layout-grid__cell--span-4-phone"
                style="padding:15px;">
                <h1 class="mdc-typography--headline1"
                    style="margin: 20px 0px; color:#ff6666; font-family: Arial, Helvetica, sans-serif; font-weight:bold;">
                    C-Square.</h1>
                <p class="first-row-text">We are a group of enthusiastic community trying to share as much knowledge as
                    we can to spread the awareness of this beautiful subject that is not yet considered mainstream. As
                    we head into the future, we need to learn more and more about the complex nature of computers and
                    computing. We are here to prepare you to take that leap into the future.</p>
            ...
            <div class="mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet mdc-layout-grid__cell--span-4-phone"
                ...
                <span>Email - <input id="email-id" value="jamiddeka1@gmail.com"></span><button id="copyEmailButton"
                    class="mdc-icon-button material-icons mdc-card__action mdc-card__action--icon--unbounded"
                    title="Copy email" style="font-size:1rem;" data-mdc-ripple-is-unbounded="true">file_copy</button>
            </div>
            <div id="app-form"
                class="mdc-layout-grid__cell--span-3 mdc-layout-grid__cell--span-4-tablet mdc-layout-grid__cell--span-4-phone"
                style="padding:16px;">
                ...
                <div class="mdc-text-field mdc-text-field--outlined" data-mdc-auto-init="MDCTextField"
                    ...
                    <input class="mdc-text-field__input" oninput="validateTextFieldsAlt()" id="text-field-hero-input"
                        name="name">
                ...
                <div class="mdc-text-field mdc-text-field--outlined" data-mdc-auto-init="MDCTextField"
                    style="margin-bottom:8px; width:100%;">
                    <input class="mdc-text-field__input" oninput="validateTextFieldsAlt()" id="text-field-hero-input-1"
                        name="email">
                    <div class="mdc-notched-outline">
                        <div class="mdc-notched-outline__leading"></div>
                        <div class="mdc-notched-outline__notch">
                ...
                <div class="mdc-select" data-mdc-auto-init="MDCSelect">
                    ...
                    <div class="mdc-select__menu demo-width-class mdc-menu mdc-menu-surface">
                        <ul class="mdc-list">
                            ...
                            <li class="mdc-list-item mdc-list-item--selected" data-value="Object Oriented Programming"
                                aria-selected="true">
