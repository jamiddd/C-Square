...
<header class="mdc-top-app-bar">
    <div class="mdc-top-app-bar__row">
        ...
        <section class="mdc-top-app-bar__section mdc-top-app-bar__section--align-end" role="toolbar">
            ...
            <a class="top-app-bar-item" href="/c_square/public/about">About</a>
            <a class="top-app-bar-item" href="/c_square/public/contacts">Contacts</a>
            <button class="mdc-button" style="background-color:white; color:purple; margin-left:10px;" onclick="window.location.href = '/c_square/public/apply'">
