	...
	<div class="mdc-layout-grid">
		<div class="mdc-layout-grid__inner">
			...
			<div
				...
				<div class="mdc-card">
					<div style="background-color:#531ceb; padding:8px;">
						<h2 class="mdc-typography--headline2" style="color:white; margin:10px 10px;">{{$course[0]}}</h2>
					</div>
					<div>
						<img src="{{asset($course[2])}}" alt="" style="height:400px; width:100%; object-fit:cover;">
					</div>
